...
penalties_applied_total = Counter(
    "penalties_applied_total", "Total number of penalties applied."
)
ranking_updates_total = Counter(
    "ranking_updates_total", "Total number of ranking updates."
)
